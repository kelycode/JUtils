...
public final class NetUtil {
    ...
    private static NetworkInfo getActiveNetworkInfo() {
        return ((ConnectivityManager) JUtils.getApp().getSystemService(Context.CONNECTIVITY_SERVICE)).getActiveNetworkInfo();
    }
    ...
    public static boolean isWifiEnabled() {
        ...
        WifiManager wifiManager = (WifiManager) JUtils.getApp().getSystemService(Context.WIFI_SERVICE);
    ...
    public static boolean isWifiConnected() {
        ConnectivityManager cm = (ConnectivityManager) JUtils.getApp().getSystemService(Context.CONNECTIVITY_SERVICE);
    ...
    public static boolean isMobileDataEnabled() {
        try {
            TelephonyManager tm = (TelephonyManager) JUtils.getApp().getSystemService(Context.TELEPHONY_SERVICE);
    ...
    public static String getIpAddressByWifi() {
        // 获取wifi服务
        WifiManager wifiManager = (WifiManager) JUtils.getApp().getApplicationContext().getSystemService(Context.WIFI_SERVICE);
        // 判断wifi是否开启
        if (!wifiManager.isWifiEnabled()) {
            wifiManager.setWifiEnabled(true);
        }
