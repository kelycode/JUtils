...
public class ServiceUtil {
    ...
    public static void startService(Class<?> cls) {
        Intent intent = new Intent(JUtils.getApp(), cls);
        JUtils.getApp().startService(intent);
    }
    ...
    public static boolean stopService(Class<?> cls) {
        Intent intent = new Intent(JUtils.getApp(), cls);
        return JUtils.getApp().stopService(intent);
    }
    ...
    public static void bindService(Class<?> cls, ServiceConnection conn, int flags) {
        Intent intent = new Intent(JUtils.getApp(), cls);
        JUtils.getApp().bindService(intent, conn, flags);
    }
    ...
    public static void unbindService(ServiceConnection conn) {
        JUtils.getApp().unbindService(conn);
    }
}
