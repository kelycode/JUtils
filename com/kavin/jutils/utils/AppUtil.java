...
public final class AppUtil {
    ...
    public static boolean isAppAlive(@NonNull String packageName) {
        ActivityManager activityManager = (ActivityManager) JUtils.getApp().getSystemService(Context.ACTIVITY_SERVICE);
    ...
    public int getAppStatus(@NonNull String packageName) {
        ActivityManager am = (ActivityManager) JUtils.getApp().getSystemService(Context.ACTIVITY_SERVICE);
    ...
    public static boolean isAppInstalled(@NonNull String packageName) {
        PackageManager pm = JUtils.getApp().getPackageManager();
        // 获取所有已安装程序的包信息
    ...
    public static void installApp(File file, String authority) {
        ...
        // 在 7.0 以上是不能直接通过 Uri 访问的
            ...
            // 参数3 : apk 文件
            uri = FileProvider.getUriForFile(JUtils.getApp(), authority, file);
    ...
    public static void uninstallApp(@NonNull String packageName) {
        ...
        intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        JUtils.getApp().startActivity(intent);
    }
    ...
    public static void launchApp(@NonNull String packageName) {
        Intent intent = JUtils.getApp().getPackageManager().getLaunchIntentForPackage(packageName);
        JUtils.getApp().startActivity(intent);
    }
    ...
    public static void exitApp() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.ICE_CREAM_SANDWICH) {
            List<Activity> activityList = JUtils.getActivityList();
    ...
    public static String getAppSignatureSHA1() {
        try {
            PackageInfo info = JUtils.getApp().getPackageManager().getPackageInfo(JUtils.getApp().getPackageName(), PackageManager.GET_SIGNATURES);
    ...
    public static void openAppSettings() {
        ...
        intent.setData(Uri.parse("package:" + JUtils.getApp().getPackageName()));
        JUtils.getApp().startActivity(intent);
    }
    ...
    public static AppInfo getAppInfo() {
        return getAppInfo(JUtils.getApp().getPackageName());
    }
