...
public final class DeviceUtil {
    ...
    public static UUID getDeviceUuid() {
        UUID uuid;
        // 先从指定文件中获取事先存储的 uuid
        final SharedPreferences prefs = JUtils.getApp().getSharedPreferences(PREFS_FILE, 0);
    ...
    public static String getAndroidID() {
        return Settings.Secure.getString(JUtils.getApp().getContentResolver(), Settings.Secure.ANDROID_ID);
    }
    ...
    public static String getDeviceId() {
        TelephonyManager telephonyManager = (TelephonyManager) JUtils.getApp().getSystemService(Context.TELEPHONY_SERVICE);
    ...
    private static String getMacAddressByWifiInfo() {
        try {
            ...
            WifiManager wifi = (WifiManager) JUtils.getApp().getSystemService(Context.WIFI_SERVICE);
            if (wifi != null) {
