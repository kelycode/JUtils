package com.kavin.jutils.utils.graphic;
...
import com.kavin.jutils.utils.graphic.blur.FastBlur;
import com.kavin.jutils.utils.graphic.blur.RSBlur;
...
public final class ImageUtil {
    ...
    public static Bitmap stackBlurByRS(Bitmap src, @IntRange(from = 0, to = 25) int radius) {
        if (src == null) return null;
        return RSBlur.blur(JUtils.getApp(), src, radius);
    }
